...
__all__ = ["LearnedGraphSetGP", "train_disturbance_gps"]
...
class LearnedGraphSetGP:
    ...
    @staticmethod
    def _features(X: np.ndarray, U: np.ndarray, t_index: Optional[np.ndarray] = None) -> np.ndarray:
    ...
    def bounds_fn(self, X: np.ndarray, U: np.ndarray,
                  t_index: Optional[np.ndarray] = None) -> Tuple[np.ndarray, np.ndarray]:
